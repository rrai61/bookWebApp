 ...
 * @author ritu
 */
@WebServlet(name = "AuthorTableEditController", urlPatterns = {"/EditController"})
public class AuthorTableEditController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] results = request.getParameterValues("authorCheck");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AuthorTableEditController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
